PIECE_BACKGROUND = """<linearGradient id="a">
...
"+B": """<g id="black-horse">
    ...
    <path fill="#63451a" fill-opacity=".75" d="M12.3 87.5h75.4v6.2H12.3z" />
    <path
        d="M41.2 67.4c5.1 2.9 10.3 2.9 15.3 0 5-3 8.7-7.5 10.8-13.5 1.2-3.5.5-5-2.7-5.8-2.9-.7-5.6-.1-8.6 1.2-1.9.8-3.8 2.2-5.8 2.9-1.6.7-2.5.1-3-.7-.5-.7-.4-2.5.1-3.5.8-1.9 2.4-4.1 3.5-6 .2-.2.1-.6-.2-.7-2.9-1.6-2.5-3.3.4-5.8 1.5-1.3 5.4-4.2 6.9-5.5 0 0-4.1 1.5-4.8 1.8-5.4 1.7-10.7 3.9-16.3 4.8-4.3.7-8.3-2.6-10.1-7-.1-.3.2-.6.4-.4 7 5.3 13.2 2.6 19.6.6 3.9-1.2 7.7-3 11.6-4.2 1.3-.4 2.9-.4 4.3-.1 1 .2 2.2.9 2.5 1.7.3.8.3 1.6-1.2 2.9-2.8 2.6-6.2 5.2-9.4 7.7-.2.1-.2.4 0 .5 5 3.2.2 5-1.4 7.5-.1.1 0 .3.2.2 2.4-.9 4.3-2 7-2.4 4.1-.7 6.5-.3 9.4.8s4.3 4.1 3.7 7.4c-2 10.7-12 23.4-24.8 22.9-3.5-.1-7.3-1.3-10.4-3.1-3.1-1.9-3.6-6.9-.5-8.5 3.9-2 8.1-1.8 12.4-.3 1.2.6 2.5 1.2 1.7 3-.6 1.6-1.2 2-3 1.6-2.3-.5-5-.7-7.4-.7-.4.1-.4.6-.2.7z"
        fill="#c30" />
    <path
        d="M36.6 33.9c-.4.2-3.5.5-3.8-.2-.4-.6-.2-.9.3-.9 1 .1 3.2.4 4 .3.4.1 0 .7-.5.8zm27.6 29.2c-.2.4-2.4 3.1-2.9 2.8-.7-.1-.6-.5-.4-.8.8-.6 2.6-2.2 3.2-2.9.3-.3.4.5.1.9z"
        fill="#fff" />
</g>
""",
"+S": """<g id="black-prosilver">
    <path fill="url(#a)" stroke="#63451a" stroke-width=".92" stroke-miterlimit="10"
        d="M74.4 17.5 50 8.7l-24.4 8.8L16.2 84v7.3h67.6V84z" />
    <path fill="#63451a" fill-opacity=".75" d="M16.7 84h66.7v6.8H16.7z" />
    <path fill="#c30"
    ...
    <path fill="#c30"
        d="M76.2 51.7c0 .3-.2.4-.4.4-.5.1-5.7.4-7.8.2-1.5-.2-3.1-.5-4.2-1.4C58.7 47 50.1 36 49.9 35.6c-.2-.4-.6-.4-.8-.1l-.9 1.2C43 44.2 38 51.9 31.3 57.9c-1.9 1.7-3.9 2.9-5.9 2.9C30.1 57.2 45.3 37 47.3 31c.3-.4.1-1.5-.3-1.9-.9-1.3-3.7-4-3.8-4.9 2.4.7 5.3 2.1 7.4 3.5 1.2.8 1.3 1.9 1 3.5-.1.3-.3 1.1-.5 1.5-.1.2-.1.4.1.6.3.3.6.6.7.8 4.2 5.2 8.5 10.3 14 13.6 1.9 1.2 8.8 2.9 10 3.5.2-.1.4.2.3.5z" />
    <path
        d="M49.4 27.9c-.2.4-1 .1-1.6-.3s-1.4-1.2-1.2-1.5c.2-.4.5-.1 1.1.2.6.5 1.9 1.3 1.7 1.6zm22.3 22.9c-.1.4-2.7.1-3.3-.1s-2.2-1.2-2.1-1.7c.1-.4 1.2.2 1.9.4.5.2 3.5.9 3.5 1.4zM43.2 71.2c0 .4-2.9.6-3.5.6-.7-.1-2.5-.4-2.5-.8s1.2 0 2.5.1c1 0 3.5-.4 3.5.1z"
        fill="#fff" />
</g>
""",
"+N": """<g id="black-proknight">
    <path fill="url(#a)" stroke="#63451a" stroke-width=".924" stroke-miterlimit="10"
        d="M73.5 19.4 50 11l-23.5 8.4-9 63V89h65v-6.6z" />
    <path fill="#63451a" fill-opacity=".75" d="M18 82.4h64v6H18z" />
    <path fill="#c30"
...
""",
"+P": """<g id="black-tokin">
    <path fill="url(#a)" stroke="#63451a" stroke-width=".944" stroke-miterlimit="10"
        d="M72.6 21.1 50 12.9l-22.6 8.2-8.7 61v5h62.6v-5z" />
    <path opacity=".75" fill="#63451a" d="M19.2 82.1h61.6v4.5H19.2z" />
    <path
        d="M41.2 29.4c2.2.8 4.6 1.4 6.7 2.3 2.1 1 2.5 2.6 2 5-.4 2.2-.7 4.5-.7 6.8 0 1.7 1.3 2.5 2.7 1.7 2-1 3.8-2.2 6.3-1.2 1.3.5 1.5 1.1.3 1.9-1.3.9-2.6 1.6-3.8 2.6-4.4 3.2-7.7 7.3-9.2 12.6-.9 3 .9 5.5 4.1 5.5 1.7 0 3.5-.3 5.2-.1 1.2.1 2.3.5 3.2 1.4.4.4.9 1.2.9 1.9-.1.3-.3.9-1.5.8-7.4-.5-18.3-.3-14.8-11.3 1.4-4.1 5.5-10.4 5.8-10.8.2-.2.2-.5-.1-.7s-.8-.4-1-.6c-2.6-1.9-1.5-4.7-1.7-7.3-.1-1.2.3-2.6-.1-3.7-.3-1-1-2-1.7-2.9-.9-1.2-2-2.2-3.1-3.3-.2-.3.1-.8.5-.6z"
        fill="#c30" />
    <path
        d="M46.7 32.6c-.3 0-3-.4-3.1-1-.2-.5 0-.7.4-.6.9.3 2.6.8 3.2 1.1.5 0 0 .4-.5.5zm-4 31.9c-.1-.3-.3-3.1.3-3.2.5-.3.7-.2.7.3 0 1-.2 2.6-.3 3.4-.2.2-.6-.2-.7-.5z"
        fill="#fff" />
</g>
""",
"k": """
<g id="white-king">
    <path fill="url(#a)" stroke="#63451a" stroke-width="1.01" stroke-miterlimit="10"
        d="M11.8 5.8V11l10.6 73.5L50 94.2l27.6-9.7L88.2 11V5.8z" />
    <path fill="#63451a" fill-opacity=".75"
        d="M77.1 78.9 50 88.6l-27.1-9.7L12.3 6.3V11l10.6 73.1L50 93.7l27.1-9.6L87.7 11V6.3z" />
    <path
        d="M48.6 58.1c1.8-.2 1.8-.7.3-2.1-2.4-2.3-3.5-2.7-3-7.3.1-.6-.3-1.1-1.2-.8-1.9.6-5.7.9-7.6 1.1-2 .2-4.1-2.6-5-5.6-.5-1.7 2-1.8 3-1.8 2.5.1 7.9-.3 9.9-.4.4 0 .8-.8.8-1.3v-7.7c0-.6-.3-1.6-.8-1.6-3.3-.1-11.2.3-15.5 0-2.7-.2-7.7-2.2-8.5-6.2-.2-.9.1-2.5.3-3.6.1-.4.4-.7.9-.7.4.1 1.1.2 1.4.3 2.9 1 5.8 2.5 8.7 3 8.8 1.4 17.5-.2 26.2-3 3.6-1.2 7.4-2.2 11-3.1 3.4-.9 8.4 4 9.5 9.3.1.4-.3.7-.6.6-5.2-2.4-10.4-2.5-15.3-1.1-3.2.9-6.2 2.3-9.4 3-1.7.5-1.7.8-1.6 2.8.1 2.1-.1 5.1-.2 7.3 0 .5.4.9.8.8 5.6-.5 11.7-.7 13.5 7 .1.4-.3.7-.5.5-6.1-3.2-11.5-1.5-13.5-1-.3.1-.5.4-.5.7-.1 3.2 1.2 7.7 1.8 9 .1.3.4.5.5.4 1-.3 3.3-.9 4.5-1 3.5-.3 6 2.3 8 6.4.2.4.3 1 .3 1.6 0 .5-.3 1.1-.7 1.2-.3.1-.6.2-.8.1-5.8-3.2-11.6-1.6-17.4-.2-4.1 1-8.1 2.3-12.1 3.3-2.8.8-5.8-1.2-6.5-4.4-.3-1-.2-2.4.1-3.4.1-.5 1.2-.5 1.7-.5 5.7-.3 17.4-1.6 17.5-1.6z" />
    <path
        d="M31.5 61.2c.3-.5 1.2-.6 4.9-.8s7-1.1 6.9-.6c-.1.5-12.4 2.5-11.8 1.4zm1.9-17.3c0-.3-.6-1.4 1.5-1.6.9-.1 2.5 1 2.5 1.2.1.8-4.1 1-4 .4zM30 24.2c.9.4-.9.9-4.1.5-.9-.1-3.2-2.7-3-3 .3-.6 5.5 1.7 7.1 2.5z"
        fill="#fff" />
</g>
""",
"gy": """
...
<g id="white-knight">
    ...
    <path
        d="M70.8 51.4c.1.2 0 .5-.3.5-.8-.1-1.9-.4-2.5-.5-2.5-1.1-5.9.6-9 2.3-.5.3-1.4 1.1-1.4 1.7-.1 3.5-.3 6.1 1.7 9.2 1.2 1.6 2.6 2.7 2.7 3.5.1.3-.1.5-.3.5-.6.2-2.2.3-3.4 0-1.6-.4-2.9-1.1-3.6-2.1-.9-1.5-.8-3.8-.5-6.6.1-1.1.1-2.3.2-3.5 0-.2-.2-.4-.3-.4-1.2.4-2.1.8-3 .7-1-.1-2.1-.7-2.8-1.6-.8-.9-.2-1.6.8-1.9 1.2-.3 4.1-1.5 5-1.7.1 0 .2-.2.2-.4 0-.5.1-2 .2-2.6 0-.7-.3-.9-.8-1.2-.7-.4-1.2 0-1.4-.4-.4-.5-.2-1.5.3-2.2.2-.3.5-.6.8-1 .1-.1.1-.4 0-.5-.9-1-1.9-2-2.8-3-.8-.9-1.8-2.1-.7-3.5s2.1-.5 2.9.8l.4.7c.2.3.4.1.4-.2 0-1.4.1-3.6.1-4.5 0-.3-.2-.5-.3-.5-.6-.2-1.7-.5-2.4-.5-1.4 0-2.9.5-4.4.7-1.2.2-2.5.6-3.3 1-.3.2-.6.6-.6 1.1 0 .8.1 2.1.2 3.4 0 .4.3.6.6.5 3.1-.7 5.2.1 6.8 3.6.1.2-.1.5-.3.5-1.5-.1-2.9-.4-4.3-.3-.8.1-1.4.2-1.9.2-.3 0-.4.3-.4.5 0 .6 0 1.7.2 2.7 0 .2.2.3.3.3 4.3-1.9 6.4-1.3 8.2 2.7.1.2 0 .5-.2.5-.7 0-1.3.1-1.9.1-1.4.2-5 .7-6.2.9-.2 0-.3.3-.3.5v2.3c.3.8.3 1.8.3 2.3 0 .2.2.3.3.3.3-.1.9-.3 1.4-.4 2.1-.5 3.5 1.2 4.9 3.4.2.2 0 .5-.3.5-1.4-.2-2.5-.4-3.6-.5-.8 0-1.9.2-2.4.3-.1 0-.2.2-.2.3 0 .7-.1 2.7.6 4 .8 1.7 2.5 3.9 3.6 5.5.1.1.3.5-.1.5 0 0-4.1.2-6.3-2-.8-.7-.9-5.5-1-6.9 0-.2-.2-.4-.3-.3-.6.3-1.9.8-2.5 1-1 .5-2.1.6-3.1.8-1.1.2-2.9-2.9-2.5-4.1.2-.5.8-.8 1.2-.9 1.3-.2 2.5-.2 3.8-.4.9-.1 2.4-.4 3-.5.2 0 .3-.2.3-.5 0-.7-.1-2.2-.3-3.8 0-.3-.3-.5-.4-.4-1.2.5-3 1.3-4.1 1.7-1.9.9-3.2-.3-4.4-1.8-.3-.5-.5-1.5-.3-1.9.2-.5.8-.7 1.4-.8 1.7-.3 3.5-.4 5.2-.5.7-.1 1.7-.4 2.1-.5.2-.1.3-.2.3-.4 0-.5 0-1.7-.1-2.6 0-.4-.3-.6-.7-.5-.8.4-1.8.8-2.4 1.1-2 1-3.4-.3-4.6-2.2-.3-.5-.3-1.4-.1-1.9.2-.4.8-.5 1.3-.6 1.5-.2 3-.2 4.6-.6.2-.1.8-.2 1.3-.3.1 0 .2-.2.2-.3-.1-.9-.2-3.6-.3-4 0-.3-.2-.4-.4-.4-.4.1-1.1.3-1.9.5-2.7.5-5.3 1.1-7.9-1.2-1.3-1.1-1.4-2.9-1.8-4.1-.1-.5.2-1 .5-.8 4.8 3.3 12.3 1 17.2 0 1.6-.4 3.1-1.1 4.7-1.1 1.1 0 2.5 1.1 3.7 2.2.3.2.5 0 .5-.4 0-1 0-2.5.1-3.5.2-2 .4-3.5 1.7-3.9 2.7-.8 6 4.2 7.6 6.6.2.3.7 1.1 1.2 1.9.2.3-.1.5-.3.5-2-1.3-3.8-2.2-5.8-3.1-.2-.1-.3.1-.3.3-.2 3.6-.3 6.9-.4 10.6 0 .3.3.5.4.3 2.5-2.2 4.5-4 6.5-5.8 2.4-2 4.8-4.1 7.8-4.5 1-.1 2.1.3 3.1.5.2 0 .3.2.3.5 0 .2-.1.4-.2.5-.3.2-.4.4-.7.5-6.7 1.7-11.6 7.2-16.3 12.9-.7.8-.4 2.8-.6 4.4v.7c0 .2.2.4.3.3.3-.1 3.3-2.1 5.2-2.6 2.9-1.3 5.3 0 7.3 3.8z" />
    <path
        d="M55.2 65.1c-.3.1-.5-.3-.5-.8s.2-.9.2-.9c.3-.1.4.4.4.8 0 .5.2.8-.1.9zm-13.3.5c.2-.1.3.3.4.7.1.5.1.8-.1.9-.2.1-.4-.3-.5-.7-.1-.3 0-.8.2-.9zm24.8-15.4c0-.4.6-.5 1.2-.5.6.1 1.1.5 1.1.8s-.5.3-1.1.2c-.6-.1-1.3-.2-1.2-.5zm-11.2-26c0-.4.6-.5 1.2-.5.6.1 1.1.5 1.1.8s-.5.3-1.1.2c-.6-.1-1.3-.2-1.2-.5zm-21.4 8.1c-.1.5-1 .7-2.1.5s-2-.6-2-1c.1-.4.9-.4 2.1-.2 1.1.2 2 .3 2 .7z"
        fill="#fff" />
</g>
""",
"l": """
...
<g id="white-horse">
    ...
    <path fill="#63451a" fill-opacity=".75"
        d="M77.1 78.9 50 88.6l-27.1-9.7L12.3 6.3V11l10.6 73.1L50 93.7l27.1-9.6L87.7 11V6.3z" />
    <path
        d="M58.9 27.2c-5.1-2.9-10.3-2.9-15.3 0-5 3-8.7 7.5-10.8 13.5-1.2 3.5-.5 5 2.7 5.8 2.9.7 5.6.1 8.6-1.2 1.9-.8 3.8-2.2 5.8-2.9 1.6-.7 2.5-.1 3 .7.5.7.4 2.5-.1 3.5-.8 1.9-2.4 4.1-3.5 6-.2.2-.1.6.2.7 2.9 1.6 2.5 3.3-.4 5.8-1.5 1.3-5.4 4.2-6.9 5.5 0 0 4.1-1.5 4.8-1.8 5.4-1.7 10.7-3.9 16.3-4.8 4.3-.7 8.3 2.6 10.1 7 .1.3-.2.6-.4.4-7-5.3-13.2-2.6-19.6-.6-3.9 1.2-7.7 3-11.6 4.2-1.3.4-2.9.4-4.3.1-1-.2-2.2-.9-2.5-1.7-.3-.8-.3-1.6 1.2-2.9 2.8-2.6 6.2-5.2 9.4-7.7.2-.1.2-.4 0-.5-5-3.2-.2-5 1.4-7.5.1-.1 0-.3-.2-.2-2.4.9-4.3 2-7 2.4-4.1.7-6.5.3-9.4-.8s-4.3-4.1-3.7-7.4c2-10.7 12-23.4 24.8-22.9 3.5.1 7.3 1.3 10.4 3.1 3.1 1.9 3.6 6.9.5 8.5-3.9 2-8.1 1.8-12.4.3-1.2-.6-2.5-1.2-1.7-3 .6-1.6 1.2-2 3-1.6 2.3.5 5 .7 7.4.7.4-.1.4-.6.2-.7z"
        fill="#c30" />
    <path
        d="M62.6 58.7c.4-.2 3.5-.5 3.8.2.4.6.2.9-.3.9-1-.1-3.2-.4-4-.3-.4-.1 0-.7.5-.8zM30.9 34.5c.2-.7 2.7-5.3 3.6-5.5 1.2-.1 1.1.4.7.8-1.1 1.3-3.3 4.5-4 5.8-.4.6-.6-.4-.3-1.1z"
        fill="#fff" />
</g>
""",
"+s": """
<g id="white-prosilver">
    <path fill="url(#a)" stroke="#63451a" stroke-miterlimit="10"
        d="M16.1 12.8v5.7l9.4 66.3L50 93.6l24.5-8.8 9.4-66.3v-5.7z" />
    <path fill="#63451a" fill-opacity=".75"
        d="m74 79.1-24 8.8-24-8.8-9.4-65.8v5.2L26 84.4l24 8.7 24-8.7 9.4-65.9v-5.2z" />
    <path fill="#c30"
        d="M36.7 23.1c0-.2.2-.3.3-.2 4.8 3.7 9.8 2.2 14.8 1.7 2.2-.3 4.4-.7 6.6-1 3.3-.4 5.6 1.4 7.6 4.5.2.2-.1.5-.3.4-2.5-1.9-7.8-1.6-10.2-1.1-.5.1-.9.3-1 .5-.4.6-.1 1.6 0 2.5 0 .2.3.3.4.1 2.1-2.7 4.8 2.7 5.2 3.6.1.3.3.7.5 1.2.3.6-.4 1.2-.9.6-1.1-1.3-2.5-2.6-3.3-3.1-2.2-1.2-2.2 1.8-2.2 1.8s-.1 2.2-.1 3.3c0 .2.2.3.3.3 3.3-1.2 6.3-.6 8.7 2.7.2.2 0 .4-.3.4-1.3-.3-2.3-.6-3.4-.6-1.1-.1-2.2.1-3.3.5-.5.2-1.3.5-1.7.7-.2.1-.3.3-.2.4.2.7.5 2.3.6 2.8.1.4.3.5.6.6.3 0 2 .5 2.6 1.5.3.5.2 1.1-.4 1.2-3.6.6-12.2 2-13.3 1.9-.4-.1-.9-.5-1.2-1.1-.3-.4-.3-1 .1-1.3.3-.3.7-.5 1-.5 2.2-.4 5-.9 7.3-1.2.3-.1.5-.4.3-.8-.5-1-1.3-2-1.7-2.4-.2-.2-.3-.3-.6-.2-.5.2-1.4.4-2.1.5-2.1.4-4.1.7-5.8-1l-.9-1.2c-.1-.1 0-.4.1-.4.6-.2 5.8-.9 8.8-1.7.2 0 .3-.2.3-.4v-2c0-.2-.2-.3-.3-.2-.9.5-3.7 1.5-5.1 1.4-1.6-.1-2.2-.6-2.4-1.4-.2-1.5 2.3-6.2 6.6-7.8.1 0 0-.1 0-.1-.7 0-1.7.1-2.2.1-2.4 0-4.8.1-7.1-.1-1.9-.1-3-2.3-2.7-5.4zm9.1 11.8c0 .1.1.1.2.1.9-.1 3.5-1 4-1.3l.2-.2c.1-.5.4-3.9-.4-4.3-.1-.1-.2 0-.3.1-1.1 1.3-3.7 5-3.7 5.6z" />
    <path fill="#c30"
        d="M24.2 45.8c0-.3.2-.4.4-.4.5-.1 5.7-.4 7.8-.2 1.5.2 3.1.5 4.2 1.4 5.1 3.9 13.7 14.9 13.9 15.3.2.4.6.4.8.1l.9-1.2c5.2-7.5 10.2-15.2 16.9-21.2 1.9-1.7 3.9-2.9 5.9-2.9-4.7 3.6-19.9 23.8-21.9 29.8-.3.4-.1 1.5.3 1.9.9 1.3 3.7 4 3.8 4.9-2.4-.7-5.3-2.1-7.4-3.5-1.2-.8-1.3-1.9-1-3.5.1-.3.3-1.1.5-1.5.1-.2.1-.4-.1-.6-.3-.3-.6-.6-.7-.8-4.2-5.2-8.5-10.3-14-13.6-1.9-1.2-8.8-2.9-10-3.5-.2.1-.4-.2-.3-.5z" />
    <path
        d="M52 62.4c.4.1.3 1 0 1.6-.3.7-.9 1.6-1.3 1.4-.4-.1-.2-.5 0-1.1.4-.7 1-2.1 1.3-1.9zm-17.8-16c0 .4-2.3.4-3 .4-.6 0-2.7-.2-2.7-.8 0-.4 1.5-.3 2.2-.3.6 0 3.4.2 3.5.7zm21.9-21.8c0-.4 2.9-.6 3.5-.6.7.1 2.5.4 2.5.8s-1.2 0-2.5-.1c-1 0-3.5.4-3.5-.1z"
        fill="#fff" />
</g>
""",
"+n": """
<g id="white-proknight">
    <path fill="url(#a)" stroke="#963" stroke-miterlimit="10"
        d="M17.5 14.3V20l9 63L50 91.4 73.5 83l9-63v-5.7z" />
    <path fill="#63451a" fill-opacity=".75" d="m73 77.5-23 8.2-23-8.2-9-62.7v5.1l9 62.7 23 8.2 23-8.2 9-62.7v-5.1z" />
    <path fill="#c30"
        d="M48.5 68.1c-.4-.5-.3-.9-.3-1.3 1.1-2.5-.7-3.6-1.9-4.8-2.5-2.5-5.2-4.7-8-6.8-2.8-2.3-10.5-5.4-10.6-5.5-.4-.3-.4-.6.1-.7.2-.1 5.8-.5 8.2.3 2.3.8 4.5 2.6 6.3 4.5 2.5 2.5 4.7 5.2 7 7.9.7.8 1.2.7 1.7-.2 1.8-2.8 3.5-5.5 5.3-8.3 3.3-5.2 6.5-10.3 9.9-15.4 1.1-1.6 3.5-5.5 5.3-4.6.1 0 .2.1.2.2 1 1.7.8 4.7.7 6.6v.2c-.1.5-.7.6-.8.2-.3-.8-.7-1.8-1-2.4-.2-.3-.6-.3-.8-.1-1.9 2.4-3.5 4.6-5.1 6.8C60.6 51 56.4 57.5 53 64.3c-1 2-1.1 3.6.3 5.3.3.3.6.6.8 1 .3.4-.1.8-.5.8-2-.6-3.7-1.7-5.1-3.3z" />
    <path fill="#c30"
        d="M49.5 30.1c-1.9 0-3.4.2-4.8-.1-1.7-.3-1.6-1.2-1.5-1.6.3-.9 1.4-1.4 1.7-1.6 2.4-1.3 3.9-1.9 6.3-3 1.1-.4 3.6.1 3.6.1-2 .5-3.5 1.7-4.6 2.5-.1.1-.1.3.1.3 1.5.2 2.3.9 2.5 1.8.3 1-.3 3-.5 4.4 1 .3 2.2.6 3.3 1.4 1.5 1 1.7 2.5.4 3.7-1.8 1.8-3.7 3.1-6.1 3.8-.4.1-.8 1.3-.9 1.8 8.1-3.1 10.7-3 12.1.3-1.4 0-2.7-.3-4 .1-2.1.5-4.1 1.3-6.3 1.9-1.3.4-2.6.8-3.9 1-1.4.2-2.3-.9-1.9-2.4.3-.9.8-1.9 1.4-3-.6-.3-1.5-.8-1.7-2-.2-.7-.1-1.9.3-2.7.9-1.9 2.2-3.5 3.3-5.2.3-.2.6-.7 1.2-1.5zm4.7 6.2c-.9-.6-1.6-.9-2.3-.9S50.2 38 50 39c1.4-.8 2.6-1.6 4.2-2.7zm0 13.7c.3.3.2.8-.3.9-2.1.5-4.1.5-5.6.8-1.2.2-4.4 0-4.1-1 .1-.4.3-.8.8-1 2.5-.8 4.6-1.4 7.2-.8.5.1 1.5.6 2 1.1z" />
    <path
        d="M33.7 49.4c.5 0 2.9.7 3 1 0 .3-2.2-.4-2.9-.4-.4 0-1.1.1-1.3-.3.1-.3.6-.4 1.2-.3zm12.8.4c.5-.1.9-.1 1 .1.2.3-.4.2-.9.5-.3.2-1.1.5-1.3.2-.2-.4.6-.7 1.2-.8zM45 27.4c.5-.2.8-.4 1-.2.3.2-.3.3-.7.7-.2.3-.9.8-1.2.6-.3-.3.4-.8.9-1.1z"
        fill="#fff" />
</g>
""",
"+l": """
...
<g id="white-tokin">
    ...
    <path opacity=".75" fill="#63451a"
        d="m72.1 76.3-22.1 8-22.1-8-8.6-60.1v5.2l8.6 58.3L50 87.6l22.1-7.9 8.6-58.3v-5.3z" />
    <path
        d="M57.8 70.6c-2.2-.8-4.6-1.4-6.7-2.3-2.1-1-2.5-2.6-2-5 .4-2.2.7-4.5.7-6.8 0-1.7-1.3-2.5-2.7-1.7-2 1-3.8 2.2-6.3 1.2-1.3-.5-1.5-1.1-.3-1.9 1.3-.9 2.6-1.6 3.8-2.6 4.4-3.2 7.7-7.3 9.2-12.6.9-3-.9-5.5-4.1-5.5-1.7 0-3.5.3-5.2.1-1.2-.1-2.3-.5-3.2-1.4-.4-.4-.9-1.2-.9-1.9.1-.3.3-.9 1.5-.8 7.4.5 18.3.3 14.8 11.3-1.4 4.1-5.5 10.4-5.8 10.8-.2.2-.2.5.1.7s.8.4 1 .6c2.6 1.9 1.5 4.7 1.7 7.3.1 1.2-.3 2.6.1 3.7.3 1 1 2 1.7 2.9.9 1.2 2 2.2 3.1 3.3.2.3-.1.8-.5.6z"
        fill="#c30" />
    <path
        d="M49.6 65.7c-.1-.3-.1-3 .5-3.2.5-.3.7-.1.7.3-.1.9-.3 2.7-.5 3.3-.3.4-.5.1-.7-.4zM42.7 30c.3-.1 2.9 0 3.2.5s.1.7-.3.7c-1-.1-2.6-.4-3.4-.5-.2-.3.2-.6.5-.7z"
        fill="#fff" />
</g>
"""
}